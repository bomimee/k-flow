          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-8">
            <div className="space-y-8">
              ...
              <div className="bg-gradient-to-r from-red-50 to-pink-50 dark:from-red-900/20 dark:to-pink-900/20 p-6 rounded-lg">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
                  <div className="text-center">
                    ...
                    <h4 className="font-semibold mb-1 dark:text-gray-100">Authentic Context</h4>
                    <p className="text-gray-600 dark:text-gray-400">Real situations and emotions</p>
                  </div>
                  <div className="text-center">
                    <div className="w-12 h-12 bg-red-500 rounded-full flex items-center justify-center mx-auto mb-2">
                      <span className="text-white font-bold">🗣️</span>
                    </div>
                    <h4 className="font-semibold mb-1 dark:text-gray-100">Natural Speech</h4>
                    <p className="text-gray-600 dark:text-gray-400">Native pronunciation patterns</p>
                  </div>
                  <div className="text-center">
                    <div className="w-12 h-12 bg-red-500 rounded-full flex items-center justify-center mx-auto mb-2">
                      <span className="text-white font-bold">🌟</span>
                    </div>
                    <h4 className="font-semibold mb-1 dark:text-gray-100">Cultural Learning</h4>
                    <p className="text-gray-600 dark:text-gray-400">Understand Korean culture</p>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-4">
                <h3 className="font-semibold text-lg dark:text-gray-100">Available K-Dramas</h3>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {demoVideoClips.map((clip) => (
                    <div key={clip.id} className="border border-gray-200 dark:border-gray-700 rounded-lg p-4 hover:border-red-300 dark:hover:border-red-500 transition-colors">
                      <div className="flex items-start space-x-4">
                        <div className="w-20 h-12 bg-gray-200 rounded flex items-center justify-center">
                          <span className="text-gray-500">🎬</span>
                        </div>
                        <div className="flex-1">
                          <h4 className="font-semibold dark:text-gray-100">{clip.title}</h4>
              ...
              {/* Features */}
              <div className="space-y-4">
                <h3 className="font-semibold text-lg dark:text-gray-100">Practice Features</h3>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="flex items-start space-x-3">
                    <span className="text-red-500 text-xl">✓</span>
                    <div>
                      <h4 className="font-semibold dark:text-gray-100">Video Clips</h4>
                      <p className="text-sm text-gray-600 dark:text-gray-400">Real K-drama scenes</p>
                    </div>
                  </div>
                  <div className="flex items-start space-x-3">
                    <span className="text-red-500 text-xl">✓</span>
                    <div>
                      <h4 className="font-semibold dark:text-gray-100">Subtitle Modes</h4>
                      <p className="text-sm text-gray-600 dark:text-gray-400">Korean, English, or none</p>
                    </div>
                  </div>
                  <div className="flex items-start space-x-3">
                    <span className="text-red-500 text-xl">✓</span>
                    <div>
                      <h4 className="font-semibold dark:text-gray-100">Mimicking Practice</h4>
                      <p className="text-sm text-gray-600 dark:text-gray-400">Step-by-step pronunciation</p>
                    </div>
                  </div>
                  <div className="flex items-start space-x-3">
                    <span className="text-red-500 text-xl">✓</span>
                    <div>
                      <h4 className="font-semibold dark:text-gray-100">Recording</h4>
                      <p className="text-sm text-gray-600 dark:text-gray-400">Compare your pronunciation</p>
                    </div>
                  </div>
                </div>
              </div>
