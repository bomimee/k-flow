          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-8">
            <div className="space-y-8">
              ...
              <div className="bg-gradient-to-r from-yellow-50 to-orange-50 dark:from-yellow-900/20 dark:to-orange-900/20 p-6 rounded-lg">
                <h3 className="font-semibold text-lg mb-4 text-yellow-900 dark:text-yellow-100">
                  🎯 The BJ Fogg Behavior Model
                </h3>
                <div className="text-center mb-6">
                  <div className="text-4xl font-bold text-yellow-600 dark:text-yellow-500 mb-2">B = M × A × P</div>
                  <p className="text-gray-600 dark:text-gray-400">Behavior = Motivation × Ability × Prompt</p>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
                  <div className="text-center">
                    ...
                    <h4 className="font-semibold mb-1 dark:text-gray-100">Motivation</h4>
                    <p className="text-gray-600 dark:text-gray-400">Your desire to do the behavior</p>
                  </div>
                  <div className="text-center">
                    <div className="w-12 h-12 bg-yellow-500 rounded-full flex items-center justify-center mx-auto mb-2">
                      <span className="text-white font-bold">A</span>
                    </div>
                    <h4 className="font-semibold mb-1 dark:text-gray-100">Ability</h4>
                    <p className="text-gray-600 dark:text-gray-400">How easy the behavior is to do</p>
                  </div>
                  <div className="text-center">
                    <div className="w-12 h-12 bg-yellow-500 rounded-full flex items-center justify-center mx-auto mb-2">
                      <span className="text-white font-bold">P</span>
                    </div>
                    <h4 className="font-semibold mb-1 dark:text-gray-100">Prompt</h4>
                    <p className="text-gray-600 dark:text-gray-400">The trigger to perform the behavior</p>
                  </div>
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                <div className="text-center p-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
                  <div className="text-2xl font-bold text-green-600 dark:text-green-500 mb-1">85%</div>
                  <div className="text-sm text-gray-600 dark:text-gray-400">Formation Score</div>
                </div>
                <div className="text-center p-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
                  <div className="text-2xl font-bold text-blue-600 dark:text-blue-500 mb-1">12</div>
                  <div className="text-sm text-gray-600 dark:text-gray-400">Active Habits</div>
                </div>
                <div className="text-center p-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
                  <div className="text-2xl font-bold text-orange-500 dark:text-orange-400 mb-1">7</div>
                  <div className="text-sm text-gray-600 dark:text-gray-400">Day Streak</div>
                </div>
                <div className="text-center p-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
                  <div className="text-2xl font-bold text-purple-600 dark:text-purple-500 mb-1">92%</div>
                    ...
                    <div key={index} className="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
                      <div className="flex items-center space-x-3">
                        <input
                          ...
                          className="w-5 h-5 text-yellow-500 dark:text-yellow-400 rounded bg-white dark:bg-gray-700 border-gray-300 dark:border-gray-600"
                          readOnly
                        />
                        <div>
                          <div className={`font-medium ${habit.completed ? 'text-gray-400' : 'text-gray-900 dark:text-gray-100'}`}>{habit.name}</div>
                          <div className="text-sm text-gray-500 dark:text-gray-400">{habit.time}</div>
                        </div>
                      </div>
                      <span className={`text-sm ${habit.completed ? 'text-green-600 dark:text-green-400' : 'text-gray-400 dark:text-gray-500'}`}>
